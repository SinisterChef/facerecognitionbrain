...
const ImageLinkForm = ({ onInputChange, onButtonSubmit }) => {
    return (
        <div className='f3'>
            ...
            <p className="text-white text-shadow fs-6 col-6 offset-3">*Clarifai changed their CORS policy. API requests are now handled through a free-tier reverse proxy server I created and deployed to Render.com to bypass this issue. Requests are a bit slower, and the first request may take up to a minute to respond.</p>
        </div>
    )
}
